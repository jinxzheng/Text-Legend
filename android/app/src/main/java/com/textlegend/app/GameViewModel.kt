...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun guildDonate(type: String) = socket.guildDonate(type)
    fun guildBuildUpgrade(branchId: String = "exp") = socket.guildBuildUpgrade(branchId)
    fun guildShopBuy(itemId: String) = socket.guildShopBuy(itemId)
